...
class ThemeProvider extends ChangeNotifier {
  bool _isDarkMode = MediaQueryData.fromWindow(WidgetsBinding.instance.window)
          .platformBrightness ==
      Brightness.dark; // Initialize based on device brightness
  ...
  ThemeData get lightTheme => ThemeData(
        ...
        elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(
            ...
            backgroundColor:
                Color(0xFFE0E5B6), // Customize button background color
            textStyle: TextStyle(
              color: Colors.black,
        ...
        cardTheme: CardTheme(
          ...
          shape: RoundedRectangleBorder(
            borderRadius:
                BorderRadius.circular(10), // Customize card border radius
          ),
        ),
  ...
  ThemeData get darkTheme => ThemeData(
        ...
        hintColor: Colors.white, // Example accent color for dark mode
        scaffoldBackgroundColor:
            Color(0xFF346751), // Example background color for dark mode
        appBarTheme: AppBarTheme(
        ...
        cardTheme: CardTheme(
          // Customize card background color for dark mode
          elevation: 2, // Customize card elevation
          shape: RoundedRectangleBorder(
            borderRadius:
                BorderRadius.circular(10), // Customize card border radius
